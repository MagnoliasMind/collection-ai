...
def main_battle_loop():
    ...
    while nagato_hp >0 and  nabiya_hp >0 :
        ...
        # 4. 检查娜比娅是否被击败
         if nagato_attack > nabiya_defense_bonus :
             nabiya_hp = nabiya_hp - nagato_attack + nabiya_defense_bonus
         else :
             nabiya_hp = nabiya_hp
         if nabiya_hp <= 0:
             break 
        ...
        # 6. 检查长门是否被击败
         if nabiya_attack > nagato_defense_bonus:
             
             nagato_hp = nagato_hp - nabiya_attack + nagato_defense_bonus
         else :
             nagato_hp = nagato_hp
         if nagato_hp <= 0:
             break 
